...
<head>
  ...
  <link href="{{ url ('adminlte/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet') }}">
</head>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ url('adminlte/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Admin Tokoku</span>
    </a>
  ...
  <footer class="main-footer">
    <!-- To the right -->
    <div class="text-center">&copy; Kingkin Fajar - 2021</div>
  </footer>
</div>
<!-- ./wrapper -->
